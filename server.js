        ...
        .prompt([
            {
                ...
                choices: ['View all Departments', 'View all Roles', 'View all Employees', 'Add a department', 'Add an Employee', 'Quit']
            }
...
function joinNew() {
    db.query("SELECT * FROM employee JOIN employee_role ON employee.employee_role = employee_role.id LEFT JOIN department ON employee_role.department= department.id;", function(err, results){
        console.table(results);
    })
}
